...
//	private static int current_year = 2022;
	...
	public static void action(Scanner input, Year year) {
		
		System.out.print("\nEnter 0 to print or 1 to change the records (Enter any other key to quit): ");
		int option = input.nextInt();
...
//			input.close();
			...
			// Loop keeps interacting with the user until the user wants to quit
			do {
				
				// Displays menu options
				System.out.println("Seattle Brazilian Church Budget");
				...
				try { choice = Integer.parseInt(option); }
				...
				switch (choice) {
					...
					// In case the user chooses addition		 
					case 1:
						
						// Calls the operation function sending the scanner and the plus operation sign as parameters
						// Continues the loop after that
						print(year);
	        	 
						break;
	                
					// In case the user chooses subtraction	
					case 2:
						
						// Calls the operation function sending the Scanner and the minus operation sign as parameters
						// Continues the loop after that
						modify(year);
	        	 
						break;
	                
					// In case the user chooses to quit the program
					case 3:
						
						// Prints "bye" and quits the loop
						System.out.println("\n" + "Bye!");     	 
						break;
					...
					default:
						...
						// Prints error message and continues the loop after that      	 
						System.out.println("\n" + "ERROR: Invalid option!" + "\n");
						break;
				}
				
			// Sets loop conditions
			} while (choice != 3);
...
//		
//		
//		offerings = new Money(9, 1, 1, 0, 2, 0, 1.07);
//		tithes = new Money(10, 12, 20, 3, 1, 0, 0);
//		week1 = new Sabbath(offerings, tithes, "JUN 04, 2022");
//		
//		offerings = new Money(2, 1, 3, 1, 3, 5, 1.15);
//		tithes = new Money(2, 12, 23, 0, 1, 1, 0);
//		week2 = new Sabbath(offerings, tithes, "JUN 11, 2022");
//		
//		offerings = new Money(0, 0, 0, 1, 4, 7, 0);
//		tithes = new Money(20, 1, 1, 0, 1, 4, 0);
//		week3 = new Sabbath(offerings, tithes, "JUN 18, 2022");
//		
//		offerings = new Money(1, 0, 4, 0, 1, 2, 0);
//		tithes = new Money(6, 0, 0, 1, 0, 3, 0.50);
...
//		
//		
//		offerings = new Money(3, 2, 4, 2, 0, 1, 0.60);
//		tithes = new Money(5, 7, 2, 6, 3, 0, 0);
//		week1 = new Sabbath(offerings, tithes, "JUL 02, 2022");
//		
//		offerings = new Money(0, 0, 0, 0, 0, 0, 0);
//		tithes = new Money(0, 0, 0, 0, 0, 0, 0);
